...
document.querySelector('#save').addEventListener('click', () => {
  ...
  xmlhttp.onloadend = function(e) {
    ...
    let theLink = "";
    theLink = theLink.concat("https://graceful-strong-carrot.glitch.me/display.html?id=", xmlhttp.responseText);
    theLink = theLink.link(theLink);

    document.getElementById("theLink").innerHTML = theLink;
    popupMessage();
    // immediately switch to display view
    //window.location = "https://graceful-strong-carrot.glitch.me/display.html";
  }
...
document.querySelector('#imgUpload').addEventListener('change', () => {
    ...
    xhr.onloadend = function(e) {
        ...
        newImage.src = "http://ecs162.org:3000/images/zepji/"+selectedFile.name;
...
document.getElementById("closePopup").addEventListener('click', closePopupMessage);
